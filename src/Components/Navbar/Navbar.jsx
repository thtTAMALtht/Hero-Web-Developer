...
const Navbar = () => {
  const links = (
    <>
      ...
      <li>
        <NavLink to="/applications" end>Apps</NavLink>
      </li>
      <li>
        <NavLink to="/installation" end>Installation</NavLink>
      </li>
    </>
  );
  return (
    <Container>
      <div className="navbar p-0">
        <div className="navbar-start ">
          <div className="dropdown">
            <div
              tabIndex={0}
              role=""
              className="cursor-pointer lg:hidden  border border-[#632ee3] rounded-sm"
            >
        ...
        <div className="navbar-end">
          <a
            href="https://github.com/thtTAMALtht?tab=repositories"
            target="_blank"
            className="btn bg-gradient-to-r from-[#6933E5] to-[#995CF1] "
          >
